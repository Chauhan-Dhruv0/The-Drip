...
// help function to load cart from localstorage
  ...
  const cartSlice = createSlice({
    ...
    extraReducers: (builder)=>{
        ...
        .addCase(updateCartItemQuantity.fulfilled, (state, action) => {
          console.log("Received updated cart:", action.payload);
          state.loading = false;
        ...
        .addCase(removeFromCart.fulfilled, (state, action) => {
          state.loading = false;
          state.cart = action.payload; // Ensure that we update the cart with the new data
          saveCartToStorage(action.payload); // Save to localStorage
      })
